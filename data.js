...
const KHO_BAI_TAP = [
    ...
    { id: "n1_2010_41", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đục lỗ (7/2010)", cau_hoi: `父が父でなくなっている。家族を統合し... <b>41. （　　）に入る最もよいものはどれか。</b>`, lua_chon: ["ところで", "とはいえ", "その結果", "それでも"], dap_an_dung: "その結果", huong_dan: "問題７　次の文章を読んで、 41 から 45 の中に入る最もよいものを、１・２・３・４から一つ選びなさい。" },
    ...
    { id: "n1_2010_46", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 8-1)", cau_hoi: `「コミュニケーション」という言葉はふつう... <b>46. コミュニケーションの全体像に最も近いものはどれか。</b>`, lua_chon: ["視線や仕草で相手と意思を疎通させること", "言葉や言葉以外の方法で思いを伝え合うこと", "黙って何も言わないことで思いを伝え合うこと", "言葉を使って相手と意思を疎通させること"], dap_an_dung: "言葉や言葉以外の方法で思いを伝え合うこと", huong_dan: "問題８　次の（１）から（４）の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
    ...
    { id: "n1_2010_50", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 9-1)", cau_hoi: `「あの人は、私が話し始めて一分とたたないうちに... <b>50. 寛容な気持ちになるとあるが、なぜそうなるのか。</b>`, lua_chon: ["相手の話が自分の話よりおもしろくて引きこまれてしまうから", "話を奪ってしまった人の態度が堂々としていて魅力的だから", "自分の代わりに話上手な人が話をしてくれれば助かるから", "相手は確かに話上手だけれど、聞き上手とは言えないから"], dap_an_dung: "相手の話が自分の話よりおもしろくて引きこまれてしまうから", huong_dan: "問題９　次の（１）から（３）の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
    ...
    // ======================================================
    // ĐỀ THI N1 THÁNG 12/2010 (ĐẦY ĐỦ)
    // ======================================================
    ...
    // --- MONDAI 7: ĐỤC LỖ (DẠNG NHÓM - ĐÃ CẬP NHẬT) ---
    {
        id: "n1_12_mondai_7",
        cap_do: "N1",
        loai: "DocHieu_Nhom",
        tieu_de: "Mondai 7: Đọc đoạn văn và chọn đáp án điền vào chỗ trống",
        huong_dan: "問題７　次の文章を読んで、 41 から 45 の中に入る最もよいものを、１・２・３・４から一つ選びなさい。",
        bai_doc: `
            <p>　いまはコミュニケーション能力が過剰に求められる時代である。職場でも学校でも、あるいはもっとプライベートな空間でもいい。あらゆる人間関係において、自分の価値を認めてもらうためには高度なコミュニケーション能力が必要とされる。書店に行けばコミュニケーション能力を高めるための自己啓発本があり余るほどでているし、わざわざそのための学校に<b>（ 41 ）</b>。</p>
            <p>　確かに、いまの産業のあり方をみると、コミュニケーションが富を生み出す経済活動の中心にきていることがわかる。製造業は人件費の安い海外に工場をどんどん移転させ、国内に残っているのは、マネジメントや企画、研究開発、マーケティングといった本社機能的な仕事ばかり。そこでは、組織をまとめあげる、アイディアを出す、交渉する、プレゼンをする、ディスカッションをするといった、高いコミュニケーション能力が必要とされる活動がどうしても物を言う。社会のあり方が、工場中心からコミュニケーション中心へと大きく転換しているのである。</p>
            <p>　しかし、コミュニケーション能力が、人びとの価値を決める独占的な尺度になることは、<b>（ 42 ）</b>。事実、コミュニケーションべたで自己アピールにそれほど（注1）長けていなくても、能力のある人はいっぱいいる。私も大学でゼミを指導していると、ゼミの議論では目立っていてもリポートの出来はそれほどでもない学生や、逆にゼミではおとなしくてもすばらしいリポートを書いてくる学生に頻繁にであう。コミュニケーションの巧みさと本人の能力は必ずしも一致しない。</p>
            <p>　もちろんコミュニケーション能力も人間の能力の一つではある。だから、それが評価基準のひとつになることは当然あっていい。</p>
            <p><b>（ 43 ）</b>コミュニケーション能力をめぐる（注2）過当な競争は、人間関係にひずみをももたらすだろう。</p>
            <p>　引きこもりは、社会のなかで要求されるコミュニケーション能力があまりに高いため、一度他者とのコミュニケーションにつまずくと、なかなか新たなコミュニケーションに踏み出せなくなってしまうことから生まれる。引きこもりまでいかなくても、周りとのコミュニケーションのなかで自分がまともに相手にされなければ、誰だって心を閉ざしてしまい、内にこもりがちになるだろう。コミュニケーション能力をめぐる競争が激しい社会は、<b>（ 44 ）</b>人にとても冷淡だ。</p>
            <p>　また、いじめは、子供たちのコミュニケーション能力の欠如からおきているのではなく、逆に、みんなが空気を読みすぎることで生じるストレスのはけ口を特定の人間に向けることでおきている。こうしたストレスや重圧は、子供に限った問題ではない。空気を壊してはならないという圧力は、人々にコミュニケーション能力をさらに要求するだろう。しかし、それが進めば、社会のなかで同調圧力が強まり、社会そのものが（注3）萎縮<b>（ 45 ）</b>。</p>
            <br>
            <div style="font-size:0.9em; background:#eee; padding:10px; border-radius:5px;">
                （萱野稔人「私の視点」 2009年4月9日付朝日新聞朝刊による ）<br>
                （注1）長（た）ける：優れている<br>
                （注2）過当（かとう）な：適当な程度を超えている<br>
    ...
    // Mondai 8: Đọc ngắn (4 câu lẻ)
    { id: "n1_12_46", cap_do: "N1", loai: "DocHieu", tieu_de: "Mondai 8-1", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>ほかの人の成功事例をマネすることが... 創造力を身につける上でまず第一に必要なのは...自分で課題を設定する能力です。</div><b>46. 筆者によると、いまの時代に創造力を養うには何が必要か。</b>`, lua_chon: ["失敗を経験しながら課題を見つけ出す力", "失敗を重ねながら課題をこなしていく力", "失敗を生かしながら課題を遂行する力", "失敗を受け入れながら課題を解く力"], dap_an_dung: "失敗を経験しながら課題を見つけ出す力", huong_dan: "問題８　次の（１）から（４）の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
    { id: "n1_12_47", cap_do: "N1", loai: "DocHieu", tieu_de: "Mondai 8-2", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>移転のお知らせ</b><br>拝啓　貴社ますますご盛栄のこととお喜び申し上げます...</div><b>47. この文書で最も伝えたいことは何か。</b>`, lua_chon: ["アサクラ株式会社の国際課が1月に山中ビルに移転すること", "アサクラ株式会社の国際課が12月に山中ビルに移転すること", "アサクラ株式会社の本社と国際課が1月に山中ビルに移転すること", "アサクラ株式会社の本社と国際課が12月に山中ビルに移転すること"], dap_an_dung: "アサクラ株式会社の国際課が12月に山中ビルに移転すること" },
    { id: "n1_12_48", cap_do: "N1", loai: "DocHieu", tieu_de: "Mondai 8-3", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>価値観や科学的常識は...</div><b>48. 筆者は、すれ違いが起こる原因をどのように説明しているか。</b>`, lua_chon: ["見る雲の形はどの世代でも変わらないが、一人一人は違う雲の形を見ているため", "見る雲の形はどの世代でも同じだが、一人一人の記憶の中で雲の形が変わっていくため", "見る雲の形は世代によって違うが、一人一人は雲の形はいつも同じだと思っているため", "見る雲の形は世代によって異なるが、一人一人の好きな雲の形はそれ以上に違うため"], dap_an_dung: "見る雲の形は世代によって違うが、一人一人は雲の形はいつも同じだと思っているため" },
    { id: "n1_12_49", cap_do: "N1", loai: "DocHieu", tieu_de: "Mondai 8-4", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>データが示す姿は光の部分もあれば影の部分もある...</div><b>49. 筆者によると、報道に携わる人間が備えておくべき必須条件とは何か。</b>`, lua_chon: ["示されたデータから影の部分を取り除く力。", "示されたデータが偏ったものではないか見抜く力。", "示されたデータをありのまま分かりやすく伝える力。", "示されたデータから報道目的に合ったものを選び取る力。"], dap_an_dung: "示されたデータが偏ったものではないか見抜く力。" },

    // --- MONDAI 9: ĐỌC TRUNG VĂN (NHÓM) ---
    {
        id: "n1_12_m9_1", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 9 (1): Mạo hiểm và nghệ sĩ",
        huong_dan: "問題９　次の（１）から（３）の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。",
        bai_doc: `<p>すでに地図の空白がなくなった現在...①近代の冒険は、その後者が重要なのだ。...②地理的な空白がなくなった時代を生きる現代の冒険家たちは...だからこそ③冒険者はアーティストでもあるといえる。</p>`,
        ds_cau_hoi_con: [
            { id: "n1_12_50", cau_hoi: "<b>50. ①について、どのような意味か。</b>", lua_chon: ["誰もが難関と感じる対象を探す", "先駆者が偉業を成し遂げた場所に挑戦", "新たな冒険の対象を見い出し独自の方法で挑戦", "誰も踏み入ったことのない場所に挑戦"], dap_an_dung: "新たな冒険の対象を見い出し独自の方法で挑戦" },
            { id: "n1_12_51", cau_hoi: "<b>51. ②地理的な空白がなくなったとはどういうことか。</b>", lua_chon: ["誰も考えつかないルートがなくなった", "自分なりの方法で冒険できる場所がなくなった", "冒険に値するルートが尽くされた", "誰も冒険したことがない場所がなくなった"], dap_an_dung: "誰も冒険したことがない場所がなくなった" },
            { id: "n1_12_52", cau_hoi: "<b>52. なぜ③冒険者はアーティストでもあるといえるのか。</b>", lua_chon: ["創造性のある自己表現が求められるから", "表現力をつけることで注目度が増すから", "自然と向き合って自己表現するから", "主体的な表現が許されているから"], dap_an_dung: "創造性のある自己表現が求められるから" }
        ]
    },
    {
        id: "n1_12_m9_2", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 9 (2): An ninh lương thực",
        bai_doc: `<p>世界の食糧供給の頭打ち...私たちは、①このへんで食糧の危機管理体制を考えておく必要があるのではないか。...②体制を制度にしておかないと...食糧の危機管理体制とは、非常事態に備えた生産から流通までの仕組み作りである。</p>`,
        ds_cau_hoi_con: [
            { id: "n1_12_53", cau_hoi: "<b>53. ①の理由は何か。</b>", lua_chon: ["今すぐ食糧を確保すべきだから", "アジアで非常事態が起きているから", "食糧の確保が今後難しくなると予想されるから", "輸出国の体制が確固としていないから"], dap_an_dung: "食糧の確保が今後難しくなると予想されるから" },
            { id: "n1_12_54", cau_hoi: "<b>54. ②体制を制度にしてとはどうすることか。</b>", lua_chon: ["生産から流通までの体制を考える", "国民が活動できる体制を整える", "政府主導で実施出来る仕組みを作る", "国民が責任を持つ仕組みを作る"], dap_an_dung: "政府主導で実施出来る仕組みを作る" },
            { id: "n1_12_55", cau_hoi: "<b>55. 筆者の考えに合うものはどれか。</b>", lua_chon: ["国民の同意を得て実施するべき", "今すぐ実施した方が良い", "平常時は実施する必要はないが制度は整えるべき", "平和な時に限らず環境を整えるべき"], dap_an_dung: "平常時は実施する必要はないが制度は整えるべき" }
        ]
    },
    {
        id: "n1_12_m9_3", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 9 (3): Kiến trúc gỗ",
        bai_doc: `<p>①日本の建築は寿命が短いが、これは木造自体の耐久性から決まるのではない。...②これは、日本独特の更新の文化と呼んでも良い。...更新は環境に優しく、人々に仕事を与え、ゆっくりとした変化をもたらす木の国の優れた文化である。</p>`,
        ds_cau_hoi_con: [
            { id: "n1_12_56", cau_hoi: "<b>56. ①の理由はなぜか。</b>", lua_chon: ["木材自体に耐久性がないため", "建築に適した木材の入手が難しく修理もしない", "老朽化が速く災害に弱い", "丈夫な木材が使えず災害で失われることも多い"], dap_an_dung: "丈夫な木材が使えず災害で失われることも多い" },
            { id: "n1_12_57", cau_hoi: "<b>57. ②これとは何を指すか。</b>", lua_chon: ["同じように建て直し外観を保持すること", "外観を変えずに建て直し景観を維持すること", "材料を再利用して建て直すこと", "景観維持を優先すること"], dap_an_dung: "外観を変えずに建て直し景観を維持すること" },
            { id: "n1_12_58", cau_hoi: "<b>58. 木造建築更新の利点は何か。</b>", lua_chon: ["質の良い木材入手と技術向上", "樹木の生育条件と街並み維持", "植林が進み環境によく技術も継承される", "木材供給安定と風景維持"], dap_an_dung: "植林が進み環境によく技術も継承される" }
        ]
    },

    // --- MONDAI 10: ĐỌC TRƯỜNG VĂN (NHÓM) ---
    {
        id: "n1_12_m10", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 10: Tâm lý học & Cảm xúc",
        huong_dan: "問題１０　次の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。",
        bai_doc: `<p>心理学は昔から心について研究してきたわけですが...えっ、感情こそ心理学が得意とするところではないのですか、と①不思議に思われるかもしれません。...②全体的な「生」の体験なのかもしれません。...ロボットもうれしそうな表情などをしてみせることはできます...しかし、それらは表面的な動作を真似しているだけで...</p>`,
        ds_cau_hoi_con: [
            { id: "n1_12_59", cau_hoi: "<b>59. ①不思議に思われるとあるが、人々は何を不思議に思うのか。</b>", lua_chon: ["感情機能についてまだ十分わかっていないこと", "認知と感情の関係が未解明なこと", "感情の研究が得意だということ", "昔から研究してきたということ"], dap_an_dung: "感情機能についてまだ十分わかっていないこと" },
            { id: "n1_12_60", cau_hoi: "<b>60. ②全体的な「生」の体験とは何か。</b>", lua_chon: ["心で感じて行動に移す体験", "目耳で認識し考え心で感じる体験", "周囲を見たり聴いたりして考える体験", "感覚や知覚でとらえようとする体験"], dap_an_dung: "目耳で認識し考え心で感じる体験" },
            { id: "n1_12_61", cau_hoi: "<b>61. ロボットを取り上げて何を説明しているか。</b>", lua_chon: ["ロボットの感情メカニズム", "ロボット工学の進歩", "人間の動作再現の難しさ", "人間の感情解明の難しさ"], dap_an_dung: "人間の感情解明の難しさ" },
            { id: "n1_12_62", cau_hoi: "<b>62. （　　）に入るものとして適切なのはどれか。</b>", lua_chon: ["何かをしたいと思い行動を起こす", "ものごとを感覚でとらえようとする", "相手の心を分析して理解しようとする", "好き嫌いを論理的に考え判断する"], dap_an_dung: "何かをしたいと思い行動を起こす" }
        ]
    },

    // --- MONDAI 11: SO SÁNH A/B (NHÓM) ---
    {
        id: "n1_12_m11", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 11: Học vấn vs Thực lực",
        huong_dan: "問題１１　次のＡとＢの意見文を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。",
        bai_doc: `
            <p><b>A</b> しっかりした人生を歩むには、やはり「学歴」が必要です。...親ならば...子供に付けさせるべきです。</p>
            <p><b>B</b> いったい、学歴とはなにものなのか。会社は、厳しい過当競争のさなかにあって、実力で勝負しなければならないというのに...「場所」というのは、正常ではない。</p>
        `,
        ds_cau_hoi_con: [
            { id: "n1_12_63", cau_hoi: "<b>63. AとBの認識で共通しているのは何か。</b>", lua_chon: ["学歴の重要性は否定できない", "学歴による区別は実在する", "学歴よりも実力が重要だ", "学歴は実益と関係がある"], dap_an_dung: "学歴による区別は実在する" },
            { id: "n1_12_64", cau_hoi: "<b>64. Bが批判しているのはどのようなことか。</b>", lua_chon: ["実社会では学歴は関係ないこと", "社会人になっても学校教育の場所が重視されること", "実力が養成されていないこと", "企業では学歴が通用しないこと"], dap_an_dung: "社会人になっても学校教育の場所が重視されること" },
            { id: "n1_12_65", cau_hoi: "<b>65. AとBの筆者の考えの組み合わせとして適切なのはどれか。</b>", lua_chon: ["A:高ければ高いほどよい / B:通用しない", "A:苦労が必要 / B:実力を重視すべき", "A:生きていくのに必要 / B:実力を重視すべき", "A:親の役目 / B:両方が必要"], dap_an_dung: "A:生きていくのに必要 / B:実力を重視すべき" }
        ]
    },

    // --- MONDAI 12: ĐỌC TRƯỜNG VĂN (NHÓM) ---
    {
        id: "n1_12_m12", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 12: Lương thưởng (Ngoại tại & Nội tại)",
        huong_dan: "問題１２　次の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。",
        bai_doc: `<p>給与には外的報酬と内的報酬のふたつがある。...①そこで得たお金は身につかないことが多い。...②まさに内的報酬が外的報酬へと実を結んでいったのである。</p>`,
        ds_cau_hoi_con: [
            { id: "n1_12_66", cau_hoi: "<b>66. 説明として本文と合っているものはどれか。</b>", lua_chon: ["外的は幅を広げる/内的は給与", "外的は将来のため/内的は努力で得られない", "外的は給与/内的は満足感が得られない", "外的は給与/内的は長く続けるために必要"], dap_an_dung: "外的は給与/内的は長く続けるために必要" },
            { id: "n1_12_67", cau_hoi: "<b>67. ①「そこ」とは何を指しているか。</b>", lua_chon: ["報酬の低い仕事", "やりがいのある仕事", "内容に釣り合わない仕事", "心の満足感を伴わない仕事"], dap_an_dung: "心の満足感を伴わない仕事" },
            { id: "n1_12_68", cau_hoi: "<b>68. ②実を結んでいったとはどういうことか。</b>", lua_chon: ["早く片づけられるようになった", "同じ会社で収入が増えた", "成長感・達成感を得る働き方が高い収入につながった", "アルバイトで正社員と同じ収入になった"], dap_an_dung: "成長感・達成感を得る働き方が高い収入につながった" },
            { id: "n1_12_69", cau_hoi: "<b>69. 筆者が最も言いたいことはどれか。</b>", lua_chon: ["高い収入が得られれば原動力になる", "すぐ収入にならなくても心の満足感を重視すべき", "アルバイトを続けることが大切", "見えない努力をすればいつか収入も高くなる"], dap_an_dung: "すぐ収入にならなくても心の満足感を重視すべき" }
        ]
    },

    // --- MONDAI 13: TÌM KIẾM THÔNG TIN (NHÓM) ---
    {
        id: "n1_12_m13", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 13: Cuộc thi dụng cụ",
        huong_dan: "右のページは、「機器・道具コンテスト」の案内である。下の問いに対する答えとして最もよいものを、１・２・３・４からひとつ選びなさい。",
        bai_doc: `<div style="text-align:center;"><img src="images/doc-hieu-2010-12-1.jpg" alt="Contest Info" style="max-width:100%; border:1px solid #ddd;"></div>
        <br>
        <b>応募者データ:</b><br>
        山田（小学生）：帽子傘 (試作品+イラスト)<br>
        鈴木（高校教師）：缶切り (メモ)<br>
        チェン（会社員）：水筒 (試作品)<br>
        川村（大学生）：キーボード (イラスト)
        `,
        ds_cau_hoi_con: [
            { id: "n1_12_70", cau_hoi: "<b>69. アイデア部門の特定課題の応募条件を満たしているのは誰か。</b>", lua_chon: ["山田さん", "鈴木さん", "チェンさん", "川村さん"], dap_an_dung: "川村さん" },
            { id: "n1_12_71", cau_hoi: "<b>70. 前川さん(ベビーカー試作)はどの部門に応募すべきか。提出物は？</b>", lua_chon: ["アイデア自由/イラスト", "アイデア自由/模型+イラスト", "開発/動画", "開発/動画+実物"], dap_an_dung: "開発/動画+実物" }
        ]
    }
];
...
const KHO_DE_THI = [
    { 
        ...
        danh_sach_cau_hoi: ["n5_bt_1", "n5_bt_2", "n5_bt_6"] 
    },
    {
        id: "n1_de_2010_7", cap_do: "N1", tieu_de: "Đề thi N1 - Tháng 7/2010 (Full)",
        danh_sach_cau_hoi: [
    ...
    },
    {
        ...
        danh_sach_cau_hoi: [
            ...
            "n1_12_mondai_7", // <--- Đã gom nhóm Mondai 7
            "n1_12_46", "n1_12_47", "n1_12_48", "n1_12_49",
            "n1_12_m9_1", "n1_12_m9_2", "n1_12_m9_3",
            "n1_12_m10",
            "n1_12_m11",
            "n1_12_m12",
            "n1_12_m13"
