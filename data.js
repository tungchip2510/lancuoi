...
const KHO_BAI_HOC = [
    ...
    { 
        ...
        noi_dung: `
            <h3 class="tieu-de-phu">Ngữ pháp (Grammar)</h3>
            <table class="bang-tu-vung">
                <thead><tr><th>Cấu trúc</th><th>Giải thích</th><th>Ví dụ</th></tr></thead>
                <tbody>
...
// ======================================================
// ======================================================
// 4. KHO ĐỀ THI THỬ (CẬP NHẬT THÊM ĐỀ N1)
// ======================================================
// Bạn hãy thay thế hoặc bổ sung đoạn này vào mảng KHO_DE_THI cũ:

const KHO_DE_THI = [
    // ... (Các đề N5 cũ giữ nguyên)
    { 
    ...
    // --- THÊM ĐỀ N1 MỚI VÀO ĐÂY ---
    {
        id: "n1_de_2010_7",
        cap_do: "N1",
        tieu_de: "Đề thi thử N1 - Tháng 7/2010 (Từ vựng & Ngữ pháp)",
        danh_sach_cau_hoi: [   // ======================================================
    // ĐỀ THI N1 (THÁNG 7/2010) - TỪ VỰNG & NGỮ PHÁP
    // ======================================================
    ...
    // Mondai 4: Cách dùng từ (Chọn câu đúng)
