...
しかし、コミュニケーション能力が、人びとの価値を決める独占的な尺度になることは、（ 42 ）。事実、コミュニケーションペたで自己アピールにそれほど（注1）長けていなくても、能力のある人はいっぱいいる。私も大学でゼミを指導していると、ゼミの議論では目立っていてもリポートの出来はそれほどでもない学生や、逆にゼミではおとなしくてもすばらしいリポートを書いてくる学生に頻繁にであう。コミュニケーションの巧みさと本人の能力は必ずしも一致しない。

もちろんコミュニケーション能力も人間の能力の一つではある。だから、それが評価基準のひとつになることは当然あっていい。（ 43 ）コミュニケーション能力をめぐる（注2）過当な競争は、人間関係にひずみをももたらすだろう。
...
また、いじめは、子供たちのコミュニケーション能力の欠如からおきているのではなく、逆に、みんなが空気を読みすぎることで生じるストレスのはけ口を特定の人間に向けることでおきている。こうしたストレスや重圧は、子供に限った問題ではない。空気を壊してはならないという圧力は、人々にコミュニケーション能力をさらに要求するだろう。しかし、それが進めば、社会のなかで同調圧力が強まり、社会そのものが（注3）萎縮（ 45 ）。
...
（注3）萎縮（いしゅく）する：元気がなくなる<br>...わざわざ「話し方教室」に<b>（ 41 ）</b>。</div><b>41. （　　）に入る最もよいものはどれか。</b>`, lua_chon: ["通う人もいるほどだ", "通う人がいるのだろうか", "通うべきである", "通うまでもなかろう"], dap_an_dung: "通う人もいるほどだ", huong_dan: "問題７　次の文章を読んで、文章全体の意味を考えて、（　　）の中に入る最もよいものを、１・２・３・４から一つ選びなさい。" },
    { id: "n1_2010_12_42", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đục lỗ (12/2010)", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'></div><b>42. （　　）に入る最もよいものはどれか。</b>`, lua_chon: ["当然のことではないか", "極めて可能性が低いのではないか", "はたして健全なのだろうか", "はたして起こり得ないのだろうか"], dap_an_dung: "はたして健全なのだろうか" },
