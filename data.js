...
const KHO_BAI_TAP = [
    ...
    // ======================================================
    // BÀI TẬP N1 (THÁNG 12/2010) - CÓ HƯỚNG DẪN
    // ======================================================
    // Mondai 1
  ...
  {
        id: "n1_12_mondai_7", // ID nhóm
        cap_do: "N1",
        loai: "DocHieu_Nhom", // Loại bài tập Nhóm
    ...
    // Mondai 10
    { id: "n1_2010_12_59", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>心理学は昔から心について研究してきたわけですが... <b>59. ①不思議に思われるとあるが、人々は何を不思議に思うのか。</b>`, lua_chon: ["心理学では感情機能についてまだ十分わかっていないこと", "心理学では認知と感情の関係がまだ解明されていないこと", "心理学は感情の働きを研究するのが得意だということ", "心理学が昔から心について研究してきたということ"], dap_an_dung: "心理学では感情機能についてまだ十分わかっていないこと", huong_dan: "問題１０　次の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
    ...
    // Mondai 11
    { id: "n1_2010_12_63", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)", cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>A</b> アートを買うか買わないか... <b>B</b> 真にアートの価値が分かるようになるためには... <b>63. AとBはアートを買うことについて、どのような考えを持っているか。</b>`, lua_chon: ["Aは一つ買ってみることがアート収集につながると考え、Bは心を動かされたらすぐに買ったほうがよいと考えている。", "Aは最初に買った作品がその後のアート収集に影響すると考え、Bはアートを理解するには買うことが欠かせないと考えている。", "Aは市場価値の高いものを買うことが重要だと考え、Bは作品が好きだと思う理由をよく考えてから買うことが大切だと考えている。", "Aは買うほどではないと思った作品でも買うことが重要だと考え、Bは作品を選ぶときの基準を高く設定することが大切だと考えている。"], dap_an_dung: "Aは最初に買った作品がその後のアート収集に影響すると考え、Bはアートを理解するには買うことが欠かせないと考えている。", huong_dan: "問題１１　次のAとBの文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
    ...
    // Mondai 13
    { id: "n1_2010_12_69", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 13)", cau_hoi: `<div style='text-align:center; margin-bottom:15px;'><img src="images/doc-hieu-2010-12-1.jpg" alt="Mondai 13" style="max-width:100%;"></div><b>69. 次の四人のうち、現段階でアイデア部門の特定課題の応募条件を満たしているのは誰か。</b>`, lua_chon: ["山田さん", "鈴木さん", "チェンさん", "川村さん"], dap_an_dung: "川村さん", huong_dan: "問題１３　次の文章を読んで、後の問いに対する答えとして最もよいものを、１・２・３・４から一つ選びなさい。" },
