...
// ======================================================
    ...
    // ======================================================
    {
        ...
        [cite_start]`, // [cite: 224-229]
        ds_cau_hoi_con: [
            {
                id: "n1_201007_q41",
                cau_hoi: "<b>41.</b>",
                lua_chon: ["ところで", "とはいえ", "その結果", "それでも"],
                [cite_start]dap_an_dung: "その結果" // [cite: 232]
            },
            {
                id: "n1_201007_q42",
                cau_hoi: "<b>42.</b>",
                lua_chon: ["親しまれることになる", "親しみやすくさえあった", "親しくなるだけのことだ", "親しめるのではなかったか"],
                [cite_start]dap_an_dung: "親しみやすくさえあった" // [cite: 247]
            },
            {
                id: "n1_201007_q44",
                cau_hoi: "<b>44.</b>",
                lua_chon: ["父である", "父ではない", "父だったのだ", "父ではないのか"],
                [cite_start]dap_an_dung: "父ではない" // [cite: 251]
            },
            {
                id: "n1_201007_q45",
                cau_hoi: "<b>45.</b>",
                lua_chon: ["対等", "上下", "他人", "家族"],
                [cite_start]dap_an_dung: "対等" // [cite: 243]
            }
        ]
    },
...

  {
    ...
    // --- MONDAI 10 (NHÓM) ---
    {
        id: "n1_12_m10", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 10: Tâm lý học",
    ...
    // --- MONDAI 11 (NHÓM) ---
    {
        ...
        bai_doc: `<p><b>A</b> しっかりした人生を歩むには、やはり「学歴」が必要です。...親ならば...子供に付けさせるべきです。</p><p><b>B</b> いったい、学歴とはなにものなのか。会社は、厳しい過当競争のさなかにあって、実力で勝負しなければならないというのに...「場所」というのは、正常ではない。</p>`,
        ds_cau_hoi_con: [
    ...
    // --- MONDAI 12 (NHÓM) ---
    {
        id: "n1_12_m12", cap_do: "N1", loai: "DocHieu_Nhom", tieu_de: "Mondai 12: Lương thưởng",
    ...
    // --- MONDAI 13 (NHÓM) ---
    {
        ...
        bai_doc: `<div style="text-align:center;"><img src="images/doc-hieu-2010-12-1.jpg" alt="Contest Info" style="max-width:100%; border:1px solid #ddd;"></div><br><b>応募者データ:</b><br>山田（小学生）：帽子傘 (試作品+イラスト)<br>鈴木（高校教師）：缶切り (メモ)<br>チェン（会社員）：水筒 (試作品)<br>川村（大学生）：キーボード (イラスト)`,
        ds_cau_hoi_con: [
...
const KHO_DE_THI = [
    ...
    // Danh sách này chứa ID của đối tượng (Object) cần render
    danh_sach_cau_hoi: [
        // Mondai 1 (Q1-Q6)
        "n1_201007_q1", "n1_201007_q2", "n1_201007_q3", "n1_201007_q4", "n1_201007_q5", "n1_201007_q6",
        // Mondai 2 (Q7-Q13)
        "n1_201007_q7", "n1_201007_q8", "n1_201007_q9", "n1_201007_q10", "n1_201007_q11", "n1_201007_q12", "n1_201007_q13",
        // Mondai 3 (Q14-Q19)
        "n1_201007_q14", "n1_201007_q15", "n1_201007_q16", "n1_201007_q17", "n1_201007_q18", "n1_201007_q19",
        // Mondai 4 (Q20-Q25)
        "n1_201007_q20", "n1_201007_q21", "n1_201007_q22", "n1_201007_q23", "n1_201007_q24", "n1_201007_q25",
        // Mondai 5 (Q26-Q35)
        "n1_201007_q26", "n1_201007_q27", "n1_201007_q28", "n1_201007_q29", "n1_201007_q30", 
        "n1_201007_q31", "n1_201007_q32", "n1_201007_q33", "n1_201007_q34", "n1_201007_q35",
        // Mondai 6 (Q36-Q40)
        "n1_201007_q36", "n1_201007_q37", "n1_201007_q38", "n1_201007_q39", "n1_201007_q40",
        
        // --- BẮT ĐẦU PHẦN BÀI NHÓM (Dùng ID của nhóm) ---
        
        // Mondai 7 (Đục lỗ) - Chứa Q41-Q45
        "n1_201007_m7", 
        
        // Mondai 8 (Đoản văn) - Chứa Q46-Q49 (Mỗi bài là 1 nhóm nhỏ)
        "n1_201007_m8_1", "n1_201007_m8_2", "n1_201007_m8_3", "n1_201007_m8_4",
        
        // Mondai 9 (Trung văn) - Chứa Q50-Q58
        "n1_201007_m9_1", "n1_201007_m9_2", "n1_201007_m9_3",
        
        // Mondai 10 (Trường văn) - Chứa Q59-Q62
        "n1_201007_m10",
        
        // Mondai 11 (So sánh A-B) - Chứa Q63-Q65
        "n1_201007_m11",
        
        // Mondai 12 (Trường văn) - Chứa Q66-Q69
        "n1_201007_m12",
        
        // Mondai 13 (Tìm kiếm thông tin) - Q70-Q71 (Xử lý như bài lẻ)
        "n1_201007_q70", "n1_201007_q71"
    ]
},
    {
