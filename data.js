...
// --- MONDAI 7: ĐỤC LỖ (41-45) ---
    {
        id: "n1_2010_12_41", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 7)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>書店に行けばコミュニケーション能力を高めるための自己啓発本があり余るほどでているし、わざわざそのための学校に<b>（ 41 ）</b>。</div><b>41. （　　）に入る最もよいものはどれか。</b>`,
        lua_chon: ["通う人もいるほどだ", "通う人がいるのだろうか", "通うべきである", "通うまでもなかろう"],
        dap_an_dung: "通う人もいるほどだ"
    },
    {
        id: "n1_2010_12_42", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 7)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>しかし、コミュニケーション能力が、人びとの価値を決める独占的な尺度になることは、<b>（ 42 ）</b>。事実、コミュニケーションべたで...</div><b>42. （　　）に入る最もよいものはどれか。</b>`,
        lua_chon: ["当然のことではないか", "極めて可能性が低いのではないか", "はたして健全なのだろうか", "はたして起こり得ないのだろうか"],
        dap_an_dung: "はたして健全なのだろうか"
    },
    {
        id: "n1_2010_12_43", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 7)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>（ 43 ）</b>コミュニケーション能力をめぐる過当な競争は、人間関係にひずみをももたらすだろう。</div><b>43. （　　）に入る最もよいものはどれか。</b>`,
        lua_chon: ["したがって", "すなわち", "それどころか", "とはいえ"],
        dap_an_dung: "とはいえ"
    },
    {
        id: "n1_2010_12_44", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 7)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>コミュニケーション能力をめぐる競争が激しい社会は、<b>（ 44 ）</b>人にとても冷淡だ。</div><b>44. （　　）に入る最もよいものはどれか。</b>`,
        lua_chon: ["こうしてつまずかせる", "そこから踏み出させる", "それにつまずいてしまった", "ここから踏み出してしまった"],
        dap_an_dung: "それにつまずいてしまった"
    },
    {
        id: "n1_2010_12_45", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 7)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>しかし、それが進めば、社会のなかで同調圧力が強まり、社会そのものが萎縮<b>（ 45 ）</b>。</div><b>45. （　　）に入る最もよいものはどれか。</b>`,
        lua_chon: ["してしまうのだろうか", "してしまうだけである", "してしまうものでもない", "してしまうとも言えまい"],
        dap_an_dung: "してしまうものでもない"
    },

    // --- MONDAI 8: ĐỌC HIỂU NGẮN (46-49) ---
    {
        id: "n1_2010_12_46", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 8-1)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>ほかの人の成功事例をマネすることが、必ずしも自分の成功を約束するものではなくなったのがいまの時代です。... 創造力を身につける上でまず第一に必要なのは、決められた課題に解を出すことでなく、自分で課題を設定する能力です。</div><b>46. 筆者によると、いまの時代に創造力を養うには何が必要か。</b>`,
    ...
    },
    {
        ...
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>移転のお知らせ</b><br>...これまで東川区にございました国際課も、12月3日に山中ビル5階に移転することになりました。...</div><b>47. この文書で最も伝えたいことは何か。</b>`,
    ...
    },
    {
        ...
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>価値観や科学的常識は、誰にとってもいつの世でも、変わらぬものだと感じがちです。... 誰もが、たまたま自分の成長期に見ていた雲こそが「正しい雲の形」だと思い込みます。こうしてそれぞれの世代の人の脳裏にある雲の姿は、お互いに少しずつズレてきて、すれ違いが起こるのです。</div><b>48. 筆者は、すれ違いが起こる原因をどのように説明しているか。</b>`,
    ...
    },
    {
        ...
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>データが示す姿は光の部分もあれば影の部分もある。... データの罠を見分ける力、すなわちデータリテラシーは... 公平で客観的な報道に努めるべきメディアに携わる人間が、しっかりと備えていなければならない必須の条件である。</div><b>49. 筆者によると、報道に携わる人間が備えておくべき必須条件とは何か。</b>`,
    ...
    // --- MONDAI 9: ĐỌC HIỂU TRUNG VĂN (50-58) ---
    {
        id: "n1_2010_12_50", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 9-1)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>すでに地図の空白がなくなった現在... ①近代の冒険は、その後者が重要なのだ。... ②地理的な空白がなくなった時代を生きる現代の冒険家たちは、そこに特別な自分なりの題材を見つけなくてはいけない。だからこそ③冒険者はアーティストでもあるといえる。</div><b>50. 筆者は①近代の冒険は、その後者が重要なのだと述べているが、それはどのような意味か。</b>`,
    ...
    },
    {
        ...
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>私たちは、①このへんで食糧の危機管理体制を考えておく必要があるのではないか。... ②体制を制度にしておかないと、食料確保のためのある程度強制力を持った政策を実施することなど不可能である。</div><b>53. ①このへんで食糧の危機管理体制を考えておく必要があるとあるが、なぜか。</b>`,
    ...
    },
    {
        ...
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>①日本の建築は寿命が短いが、これは木造自体の耐久性から決まるのではない。... しかし、構造部材のメンテナンスが必要なので耐久性を考えると大材を用いたほうが良い。... ②これは、日本独特の更新の文化と呼んでも良い。</div><b>56. ①日本の建築は寿命が短いとあるが、なぜか。</b>`,
    ...
    // --- MONDAI 10: ĐỌC HIỂU TRƯỜNG VĂN (59-62) ---
    {
        id: "n1_2010_12_59", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>えっ、感情こそ心理学が得意とするところではないのですか、と①不思議に思われるかもしれません。... ②全体的な「生」の体験なのかもしれません。</div><b>59. ①不思議に思われるとあるが、人々は何を不思議に思うのか。</b>`,
        lua_chon: ["心理学では感情機能についてまだ十分わかっていないこと", "心理学では認知と感情の関係がまだ解明されていないこと", "心理学は感情の働きを研究するのが得意だということ", "心理学が昔から心について研究してきたということ"],
        dap_an_dung: "心理学では感情機能についてまだ十分わかっていないこと"
    },
    {
    ...
    // --- MONDAI 11: SO SÁNH A-B (63-65) ---
    {
        id: "n1_2010_12_63", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>A</b> しっかりした人生を歩むには、やはり「学歴」が必要です。... <br><br><b>B</b> いったい、学歴とはなにものなのか。...</div><b>63. AとBの認識で共通しているのは何か。</b>`,
        lua_chon: ["学歴の重要性は否定できない。", "学歴による区別は実在する。", "学歴よりも実力が重要だ。", "学歴は実益と関係がある。"],
        dap_an_dung: "学歴による区別は実在する。"
    },
    {
    ...
    {
        id: "n1_2010_12_65", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)",
        cau_hoi: `<b>65. AとBの二つの文章を以下のようにまとめる場合、①と②に入るものの組み合わせとして適切なのはどれか。</b>`,
        lua_chon: ["①学歴が高ければ高いほどよい　②会社で競争に勝つには学歴は通用しない", "①学歴を得るために苦労が必要だ　②会社は社員の学歴より実力を重視するべきだ", "①学歴は生きていくのに必要なものだ　②会社は社員の学歴より実力を重視するべきだ", "①子供に学歴を付けさせるのは親の役目だ　②社員は専門の知識と学歴の両方が必要だ"],
        dap_an_dung: "①学歴は生きていくのに必要なものだ　②会社は社員の学歴より実力を重視するべきだ"
    },

    // --- MONDAI 12: ĐỌC HIỂU TRƯỜNG VĂN (66-69) ---
    {
        id: "n1_2010_12_66", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)",
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>給与には外的報酬と内的報酬のふたつがある。... ①そこで得たお金は身につかないことが多い。... ②まさに内的報酬が外的報酬へと実を結んでいったのである。</div><b>66. 外的報酬と内的報酬の説明として本文と合っているものはどれか。</b>`,
        lua_chon: ["外的報酬は仕事の幅を広げるのに必要なものであり、内的報酬は会社から評価され給与として得られるもの", "外的報酬は将来の自分のために必要なものであり、内的報酬は自分の努力では得られないもの", "外的報酬は給与として得られるものであり、内的報酬は長期的には満足感が得られないもの", "外的報酬は他人から評価され得られるものであり、内的報酬は仕事を長く続けるために必要なもの"],
        dap_an_dung: "外的報酬は他人から評価され得られるものであり、内的報酬は仕事を長く続けるために必要なもの"
    },
    {
    ...
    {
        id: "n1_2010_12_69", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)",
        cau_hoi: `<b>69. この文章で筆者が最も言いたいことはどれか。</b>`,
        lua_chon: ["人脈や仕事の幅を広げて高い収入を得ることができれば、それが仕事の原動力になる。", "すぐに高い収入に結びつかなくても、心の満足感を重視して仕事を続けることが大切だ。", "大きな収入を得たいと考えるなら、アルバイトを続け高い技術や人脈を得ることが大切だ。", "見えないところで努力して仕事をすれば、他人が高く評価してくれ、いつか収入も高くなる。"],
        dap_an_dung: "すぐに高い収入に結びつかなくても、心の満足感を重視して仕事を続けることが大切だ。"
    },

    // --- MONDAI 13: TÌM KIẾM THÔNG TIN (70-71) ---
    {
        id: "n1_2010_12_70", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 13)",
        cau_hoi: `<div style='text-align:center; margin-bottom:15px;'><img src="doc-hieu-2010-12-1.jpg" alt="Mondai 13" style="max-width:100%;"></div><b>70. 次の四人のうち、現段階でアイデア部門の特定課題の応募条件を満たしているのは誰か。</b>`,
        lua_chon: ["山田さん", "鈴木さん", "チェンさん", "川村さん"],
        dap_an_dung: "川村さん"
    },
    {
        id: "n1_2010_12_71", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 13)",
        cau_hoi: `<b>71. 前川さんは... どの部門に応募するのが適切か。</b>`,
