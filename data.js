...
// ======================================================
  ...
  // ======================================================
    ...
    },
    {
        ...
        cau_hoi: `
            <div style="background:#f9f9f9; padding:15px; border-radius:8px; margin-bottom:15px; line-height:1.6; text-align:justify;">
                <p style="text-align:right;">2010年11月10日</p>
                <b>移転のお知らせ</b><br>
   ...
   // ======================================================
    // N1 - THÁNG 12/2010 - MONDAI 9 (ĐỌC TRUNG VĂN)
    // ======================================================
    {
        id: "n1_2010_12_m9_1",
        cap_do: "N1",
        ...
        bai_doc: `
            <div style="background:#f9f9f9; padding:15px; border-radius:8px; line-height:1.8;">
                <p>すでに地図の空白がなくなった現在、地理的な冒険や探検といった行為は、時間が経つにつれてどんどん不可能になってきている。ジャーナリストの本多勝一氏は、冒険の条件として「命の危険性」と「行為の主体性」の二つをあげているが、①<u>近代の冒険は、その後者が重要なのだ</u>。それはつまり自己表現の問題とも密接に関わってくる。</p>
                <p>②<u>地理的な空白がなくなった時代を生きる現代の冒険家たちは</u>、前人未踏のルートを開拓したり、誰もやらなかった方法で何かを成し遂げることで、自らの行為の主体性を確保するしかない。登山家がより難しいルートを選んで山に登ろうとするのも、単独無酸素といった過酷な条件を自らに課すのも、そうしないと現代では冒険が成立しにくいからである。</p>
                <p>だからこそ③<u>冒険者はアーティストでもあるといえる</u>。アーティストが白いキャンパスに自分なりの絵を描くように、冒険者は自然というキャンパスに、自らの肉体を使って自分だけのラインを描こうとする。</p>
            </div>
        `,
        ds_cau_hoi_con: [
            {
                id: "n1_2010_12_50",
                cau_hoi: "<b>50. ①「近代の冒険は、その後者が重要なのだ」について、筆者はどのような意味で述べているか。</b>",
                lua_chon: ["誰もが難関と感じる対象を探すこと", "先駆者が偉業を成し遂げた場所に挑戦すること", "新たな冒険の対象を見い出し独自の方法で挑戦すること", "誰も踏み入ったことのない場所に挑戦すること"],
                dap_an_dung: "新たな冒険の対象を見い出し独自の方法で挑戦すること"
            },
            {
                id: "n1_2010_12_51",
                cau_hoi: "<b>51. ②「地理的な空白がなくなった」とはどういうことか。</b>",
                lua_chon: ["誰も考えつかないルートがなくなった", "自分なりの方法で冒険できる場所がなくなった", "冒険に値するルートが尽くされた", "誰も冒険したことがない場所がなくなった"],
                dap_an_dung: "誰も冒険したことがない場所がなくなった"
            },
            {
                id: "n1_2010_12_52",
                cau_hoi: "<b>52. なぜ③「冒険者はアーティストでもあるといえる」のか。</b>",
                lua_chon: ["創造性のある自己表現が求められるから", "表現力をつけることで注目度が増すから", "自然と向き合って自己表現するから", "主体的な表現が許されているから"],
                dap_an_dung: "創造性のある自己表現が求められるから"
            }
        ]
    },
    {
        ...
        bai_doc: `
            <div style="background:#e3f2fd; padding:15px; border-radius:8px; line-height:1.8;">
                <p>世界の食糧供給の頭打ち傾向がはっきりしてきた。人口増加と新興国の経済成長による食生活の向上で需要は急増しているのに、生産の伸びは期待できない。食糧輸出国がいつ輸出規制に動くかわからない。</p>
                <p>私たちは、①<u>このへんで食糧の危機管理体制を考えておく必要があるのではないか</u>。お金を出せば買えるという時代は、そう長くは続かないだろう。国内生産を増やす努力をすると同時に、不測の事態に備えたセーフティーネット（安全網）を張っておくべきだ。</p>
                <p>農家が生産意欲を持てるような、そして国民が飢えることのないような②<u>体制を制度にしておかないと</u>、手遅れになる。</p>
                <p>食糧の危機管理体制とは、非常事態に備えた生産から流通までの仕組み作りである。それは、平時には無駄に見えるかもしれないが、平和な時にこそ整えておくべき保険のようなものだ。</p>
            </div>
        `,
        ds_cau_hoi_con: [
            {
                id: "n1_2010_12_53",
                cau_hoi: "<b>53. ①「このへんで食糧の危機管理体制を考えておく必要がある」の理由は何か。</b>",
                lua_chon: ["今すぐ食糧を確保すべきだから", "アジアで非常事態が起きているから", "食糧の確保が今後難しくなると予想されるから", "輸出国の体制が確固としていないから"],
                dap_an_dung: "食糧の確保が今後難しくなると予想されるから"
            },
            {
                id: "n1_2010_12_54",
                cau_hoi: "<b>54. ②「体制を制度にして」とはどうすることか。</b>",
                lua_chon: ["生産から流通までの体制を考える", "国民が活動できる体制を整える", "政府主導で実施出来る仕組みを作る", "国民が責任を持つ仕組みを作る"],
                dap_an_dung: "政府主導で実施出来る仕組みを作る"
            },
            {
                id: "n1_2010_12_55",
                cau_hoi: "<b>55. 筆者の考えに合うものはどれか。</b>",
                lua_chon: ["国民の同意を得て実施するべき", "今すぐ実施した方が良い", "平常時は実施する必要はないが制度は整えるべき", "平和な時に限らず環境を整えるべき"],
                dap_an_dung: "平常時は実施する必要はないが制度は整えるべき"
            }
        ]
    },
    {
        ...
        bai_doc: `
            <div style="background:#fff3e0; padding:15px; border-radius:8px; line-height:1.8;">
                <p>①<u>日本の建築は寿命が短い</u>が、これは木造自体の耐久性から決まるのではない。木造建築でも、適切なメンテナンスをすれば数百年は持つ。しかし、日本では古くなると建て替えることが多い。</p>
                <p>②<u>これは、日本独特の更新の文化と呼んでも良い</u>。建物が老朽化しても、全く同じデザイン、同じ工法で建て直すことで、街並みや景観は維持される。伊勢神宮の式年遷宮がその代表例だ。</p>
                <p>更新は環境に優しく、人々に仕事を与え、ゆっくりとした変化をもたらす木の国の優れた文化である。木材を使い、森を育て、技術を継承していくサイクルがそこにはある。</p>
            </div>
        `,
        ds_cau_hoi_con: [
            {
                id: "n1_2010_12_56",
                cau_hoi: "<b>56. ①「日本の建築は寿命が短い」とあるが、その理由はなぜか。</b>",
                lua_chon: ["木材自体に耐久性がないため", "建築に適した木材の入手が難しく修理もしない", "老朽化が速く災害に弱い", "丈夫な木材が使えず災害で失われることも多い"],
                dap_an_dung: "丈夫な木材が使えず災害で失われることも多い"
            },
            {
                id: "n1_2010_12_57",
                cau_hoi: "<b>57. ②「これ」とは何を指すか。</b>",
                lua_chon: ["同じように建て直し外観を保持すること", "外観を変えずに建て直し景観を維持すること", "材料を再利用して建て直すこと", "景観維持を優先すること"],
                dap_an_dung: "外観を変えずに建て直し景観を維持すること"
            },
            {
                id: "n1_2010_12_58",
                cau_hoi: "<b>58. 木造建築更新の利点は何か。</b>",
                lua_chon: ["質の良い木材入手と技術向上", "樹木の生育条件と街並み維持", "植林が進み環境によく技術も継承される", "木材供給安定と風景維持"],
                dap_an_dung: "植林が進み環境によく技術も継承される"
            }
        ]
    },
