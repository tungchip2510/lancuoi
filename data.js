...
// ======================================================
const KHO_BAI_HOC = [
    // ... (Vui lòng giữ nguyên code các bài học N5 từ 1-25 của bạn ở đây) ...
    { 
        id: "n5_tv_1", cap_do: "N5", loai: "TuVung", tieu_de: "BÀI 1: TÔI LÀ... - Từ vựng", 
        noi_dung: `<h3 class="tieu-de-phu">Từ vựng (Vocabulary)</h3><table class="bang-tu-vung"><thead><tr><th>Hán tự/Kana</th><th>Romaji</th><th>Nghĩa Việt</th><th>Ghi chú</th></tr></thead><tbody><tr><td>わたし</td><td>watashi</td><td>Tôi</td><td>Dùng cho cả nam và nữ</td></tr></tbody></table>` 
    },
    // ...
];
...
const KHO_BAI_TAP = [
    ...
    // ======================================================
    // BÀI TẬP N1 (THÁNG 7/2010) - ĐẦY ĐỦ 71 CÂU
    // ======================================================
    ...
    // --- Bổ sung Mondai 10-13 cho đề Tháng 7/2010 ---
    { 
        id: "n1_2010_59", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)", 
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>心理学は昔から心について研究してきたわけですが... <b>59. ①不思議に思われるとあるが、人々は何を不思議に思うのか。</b>`, 
    ...
    { id: "n1_2010_60", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)", cau_hoi: `<b>60. 筆者の言う②全体的な「生」の体験とは何か。</b>`, lua_chon: ["心で感じとったことを、そのまま行動に移すような体験", "身の回りの世界を目や耳で認識して考え、心で感じる体験", "どのように周囲を見たり聴いたりして考えるかという体験", "感覚や知覚で周囲の世界のものごとをとらえようとする体験"], dap_an_dung: "身の回りの世界を目や耳で認識して考え、心で感じる体験" },
    { id: "n1_2010_61", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)", cau_hoi: `<b>61. この文章では、ロボットを取り上げて何を説明しているか。</b>`, lua_chon: ["ロボットの感情のメカニズムの複雑さ", "最近のロボット工学の進歩のめざましさ", "人間の動作や表情を再現することの難しさ", "人間の感情の働きを解明することの難しさ"], dap_an_dung: "人間の感情の働きを解明することの難しさ" },
    { id: "n1_2010_62", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 10)", cau_hoi: `<b>62. 筆者の述べている感情の働きを以下のようにまとめる場合、（　　）に入るものとして適切なのはどれか。</b>`, lua_chon: ["何かをしたいと思い行動を起こす", "ものごとを感覚でとらえようとする", "相手の心を分析して理解しようとする", "好き嫌いを論理的に考え判断する"], dap_an_dung: "何かをしたいと思い行動を起こす" },
    { 
        id: "n1_2010_63", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)", 
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'><b>A</b> しっかりした人生を歩むには... <b>B</b> いったい、学歴とは... <b>63. AとBの認識で共通しているのは何か。</b>`, 
        lua_chon: ["学歴の重要性は否定できない。", "学歴による区別は実在する。", "学歴よりも実力が重要だ。", "学歴は実益と関係がある。"], 
        dap_an_dung: "学歴による区別は実在する。" 
    },
    { id: "n1_2010_64", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)", cau_hoi: `<b>64. 学歴や学校教育について、Bが批判しているのはどのようなことか。</b>`, lua_chon: ["実際の社会では学歴は関係なく、何でもできる人が高く評価されること", "社会人になってからも、どこで学校教育を受けたかが重要視されること", "実際の社会で必要とされる実力が、学校教育では養成されていないこと", "社会的には学歴が重視されているのに、企業ではそれが通用しないこと"], dap_an_dung: "社会人になってからも、どこで学校教育を受けたかが重要視されること" },
    { id: "n1_2010_65", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 11)", cau_hoi: `<b>65. AとBの二つの文章を以下のようにまとめる場合、①と②に入るものの組み合わせとして適切なのはどれか。</b>`, lua_chon: ["①学歴が高ければ高いほどよい　②会社で競争に勝つには学歴は通用しない", "①学歴を得るために苦労が必要だ　②会社は社員の学歴より実力を重視するべきだ", "①学歴は生きていくのに必要なものだ　②会社は社員の学歴より実力を重視するべきだ", "①子供に学歴を付けさせるのは親の役目だ　②社員は専門の知識と学歴の両方が必要だ"], dap_an_dung: "①学歴は生きていくのに必要なものだ　②会社は社員の学歴より実力を重視するべきだ" },
    { 
        id: "n1_2010_66", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)", 
        cau_hoi: `<div style='text-align:justify; background:#f9f9f9; padding:10px; border-radius:5px; margin-bottom:10px;'>給与には外的報酬と内的報酬のふたつがある... <b>66. 外的報酬と内的報酬の説明として本文と合っているものはどれか。</b>`, 
    ...
    { id: "n1_2010_67", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)", cau_hoi: `<b>67. ①そこで得たお金の「そこ」とは何を指しているか。</b>`, lua_chon: ["報酬の低い仕事", "やりがいのある仕事", "内容に釣り合わない仕事", "心の満足感を伴わない仕事"], dap_an_dung: "心の満足感を伴わない仕事" },
    { id: "n1_2010_68", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)", cau_hoi: `<b>68. ②まさに内的報酬が外的報酬へと実を結んでいったとあるが、どういうことか。</b>`, lua_chon: ["仕事に慣れて早く片づけられるようになり、同僚と同じ金額の収入を得た。", "ボーナスも退職金もないが、同じ会社で仕事を続けた結果、収入が増えた。", "成長感や達成感を得るために働いてきたことが、高い収入につながった。", "10年間アルバイトを続けて、正社員と同じ収入を得られるようになった。"], dap_an_dung: "成長感や達成感を得るために働いてきたことが、高い収入につながった。" },
    { id: "n1_2010_69", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 12)", cau_hoi: `<b>69. この文章で筆者が最も言いたいことはどれか。</b>`, lua_chon: ["人脈や仕事の幅を広げて高い収入を得ることができれば、それが仕事の原動力になる。", "すぐに高い収入に結びつかなくても、心の満足感を重視して仕事を続けることが大切だ。", "大きな収入を得たいと考えるなら、アルバイトを続け高い技術や人脈を得ることが大切だ。", "見えないところで努力して仕事をすれば、他人が高く評価してくれ、いつか収入も高くなる。"], dap_an_dung: "すぐに高い収入に結びつかなくても、心の満足感を重視して仕事を続けることが大切だ。" },
    { 
        id: "n1_2010_70", cap_do: "N1", loai: "DocHieu", tieu_de: "N1 - Đọc hiểu (Mondai 13)", 
        cau_hoi: `<div style='text-align:center; margin-bottom:15px;'><img src="images/doc-hieu-2010-7-1.jpg" alt="Mondai 13" style="max-width:100%;"></div><b>70. 高木さんが制作した以下の作品のうち、応募できるものはどれか。</b>`, 
    ...
    { 
        ...
        cau_hoi: `<div style='text-align:center; margin-bottom:15px;'><img src="images/doc-hieu-2010-7-2.jpg" alt="Mondai 13-2" style="max-width:100%;"></div><b>71. 入賞したかどうかを知るには、高木さんはどうしたらよいか。</b>`, 
...
// ======================================================
// 4. KHO ĐỀ THI THỬ (CẬP NHẬT DANH SÁCH ID)
// ======================================================
const KHO_DE_THI = [
    { 
