...
// ======================================================
    ...
    // ======================================================
    {
        ...
        cap_do: "N1",
        loai: "DocHieu_Nhom",
        tieu_de: "Mondai 10: Phỏng vấn người bình thường (普通の人の取材)",
        bai_doc: `
            <div style="background:#fff; padding:20px; border:1px solid #eee; border-radius:8px; line-height:1.8; text-align:justify;">
                <p>　以下は、長年インタビューを仕事にしている人が書いた文章である。</p>
                <p>　何かと取材しつくされたような今の時代にも、乗った電車で横に座った、ぐらいの近くにいる普通の人たちの辿った過去、精神的な道のりを取材することには①<span style="text-decoration: underline;">可能性が残されている</span>。これは幸福な感触だった。普通の人に対して、話題の人物と同じような方法でなるべく丁寧に話をうかがってみたけれど（そのうちの一部分は、これはある職業における普通の人たちへのインタビューとして、昨年発表した拙著「善き書店員」という本にまとめた）。特殊な人物の発言よりむしろそんな普通の人たちの実感こそ、数十年後に振り返れば時代の証言にも聞こえるのではと思うようになっていった。②<span style="text-decoration: underline;">有意義な取材</span>が開拓されきったような空白の時代に、特別で極端な物語はもういいやという状況で隙間を見つけようとして、そこら辺にごろんと転がっている声の実りにたまたま気づかされたわけだ。</p>
                <p>　過去は、文句の言えない形で③<span style="text-decoration: underline;">「これだ」</span>と見せられるようなものではない。映像などで記録されていてさえ、人物の内面で起きた心の大事件みたいなものは捉えられなかったりもする。解釈は変化するから、同じ出来事への同じ人物の談話も十年前と今でかなり異なることもよくあり、つまり過去は人物の内面で揺れ動き続けていて、形を持たない怪物のようでもある。過去の解釈は、本人が切実に感じているからこそ人生に陰影を与えるため、主観の記憶の何が真実かさえも重要ではない場面がある。有名無名を問わず、さまざまな方に取材で話をうかがううちに、この過去という確固たる形を持たず動き続ける怪物にこそ人間は振り回されたり、あるいは歩き続けていくための滋養（注）をもらったりするようだな、と思うようになっていった。</p>
                <div style="margin-top:15px; font-size:0.9em; background:#f5f5f5; padding:10px; border-radius:5px;">
                    （木村俊介「暮しの手帖」2014年 6-7月号による）<br>
                    （注）滋養：ここでは、力
                </div>
            </div>
        `,
        ds_cau_hoi_con: [
            {
                id: "n1_2015_12_56",
                cau_hoi: "<b>56. ①可能性とはどのようなことか。</b>",
                lua_chon: [
                    "普通の人のほうが、丁寧に取材に応じてくれること",
                    "普通の実感に、取材すべきものを見いだせること",
                    "普通の人への取材では、共感できる話を聞けること",
                    "普通の人への取材のほうが、幸福な時間に感じられること"
                ],
                dap_an_dung: "普通の実感に、取材すべきものを見いだせること" // (時代の証言にも聞こえるのではと思う)
            },
            {
                id: "n1_2015_12_57",
                cau_hoi: "<b>57. ②有意義な取材とはどのようなものだったか。</b>",
                lua_chon: [
                ...
                dap_an_dung: "特別な人から特別な話を聞く。" // (Lưu ý: Đoạn văn nói "Trong thời đại trống rỗng mà những cuộc phỏng vấn có ý nghĩa ĐÃ ĐƯỢC KHAI THÁC HẾT RỒI...". Nghĩa là "những cuộc phỏng vấn người nổi tiếng/đặc biệt" đã bão hòa. Tác giả tìm ra cái mới là "người bình thường". Vậy "Yuigi na shuzai" ở đây ám chỉ loại phỏng vấn cũ, kinh điển, tức là phỏng vấn người đặc biệt. Câu tiếp theo "Tokubetsu de kyokutan na monogatari wa mou ii ya" củng cố ý này.)
            },
            {
                id: "n1_2015_12_58",
                cau_hoi: "<b>58. 過去は③「これだ」と見せられるようなものではないとあるが、なぜか。</b>",
                lua_chon: [
                    "過去は心の中で形を変えていくものだから",
                ...
                dap_an_dung: "過去は心の中で形を変えていくものだから" // (解釈は変化するから...過去は人物の内面で揺れ動き続けていて)
            }
        ]
    },
        ...
        ds_cau_hoi_con: [
            {
                ...
                dap_an_dung: "感情の反応のほうが大きな個人差が見られる。" //
            },
            {
                id: "n1_2016_07_60",
                ...
                dap_an_dung: "不確実な状況において、判断して決断するためのもの" //
            },
            {
                id: "n1_2016_07_61",
                ...
                dap_an_dung: "人間という生物種の存続" // (別の選択をした人が生きのびれば生物種としては存続できる)
            },
            {
                id: "n1_2016_07_62",
...

{
        ...
        danh_sach_cau_hoi: [
            ...
            "n1_2016_07_m7","n1_2015_12_m9_1", "n1_2015_12_m10_3" "n1_2016_07_m10", "n1_2016_07_m12", "n1_2016_07_m13"
        ]
    },
